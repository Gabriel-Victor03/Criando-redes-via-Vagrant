Vagrant.configure("2") do |config|
  ...
  vm1.vm.provision "shell", path: "sh/vm1.sh"#, inline: "echo Maquina Virtual 1 rodando"
...
# -------------------------------------------------------------------------
  config.vm.define "vm2" do |vm2|
    ...
    vm2.vm.provision "shell", path: "sh/vm2.sh"# , inline: "echo Vm2Maquina Virtual 2 rodando"
  end
# -------------------------------------------------------------------------
  config.vm.define "vm3" do |vm3|
    ...
    vm3.vm.provision "shell", path: "sh/vm3.sh" #, inline: "echo Vm3Maquina Virtual 3 rodando"
