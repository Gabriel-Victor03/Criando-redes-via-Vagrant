...
config.vm.define "vm3" do |vm3|
  ...
  #vm1.vm.provision "shell" do |provedor_vm1|
  #  provedor_vm1.inline = "sudo ip route add default via 192.168.50.12"
  #end
  #vm2.vm.provision "shell" do |provedor_vm2|
  #  provedor_vm2.inline = "sudo ip route add default via 192.168.50.12"
  #end
  #vm2.vm.provision "shell" do |provedor_vm3|
  #  provedor_vm3.inline = "sudo ip route add default via 192.168.50.12"
  #end
